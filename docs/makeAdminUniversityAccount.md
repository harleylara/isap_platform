...
4. Activate this account.
   ...
   3. Enter the Email Address of Admin University account and press Confirm button  
   4. The Error like below picture will emerge but no probrem, please login as a Administorator  
      <img src="images/error_reset.png" width="200px" />  
   5. See the user detail of Admin University account and click the link green background  
      <img src="images/reset_green_link.png" width="500px" />  
   6. Enter the password and press Confirm button
